...
const ChatWidget: React.FC = () => {
  ...
  const [messages, setMessages] = useState<ChatMessage[]>([
    {
      role: 'model',
      text: "Hi there! Welcome to YIKANG TCM PRAKTIJK. How can I help you with your wellness journey today?",
      timestamp: new Date()
    }
  ]);
  ...
  const handleSend = async () => {
    ...
    try {
      ...
      setMessages(prev => [...prev, {
        role: 'model',
        text: "I'm having a little trouble connecting to the universal energy (and the server). Please try again later.",
        timestamp: new Date()
      }]);
    } finally {
      setIsLoading(false);
          ...
          >
            ...
            <div className="bg-gold-500 p-4 flex items-center justify-between text-white">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-sm">YIKANG Assistant</h3>
