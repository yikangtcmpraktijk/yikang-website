    ...
    <section id="contact" className="py-24 bg-primary-900 scroll-mt-28">
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center mb-16">
            <h2 className="font-serif text-4xl md:text-5xl text-white mb-6">Visit Yikang TCM Praktijk</h2>
            <p className="text-primary-200 text-lg leading-relaxed max-w-2xl mx-auto">
              We believe in a personal approach to healing. Please contact us directly via phone, WhatsApp, or email to schedule your appointment.
            </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-primary-800 p-8 rounded-3xl text-center border border-primary-700 hover:border-gold-500/30 hover:shadow-lg transition-all group">
                ...
                <h3 className="font-serif text-xl font-bold text-primary-50 mb-4">Address</h3>
            ...
            <div className="bg-gradient-to-br from-gold-500 to-gold-700 p-8 rounded-3xl text-center text-white shadow-xl transform md:-translate-y-4 border border-gold-400/20">
                ...
                <div className="mb-4">
                  <p className="text-gold-100 text-sm mb-1">Telephone</p>
            ...
            <div className="bg-primary-800 p-8 rounded-3xl text-center border border-primary-700 hover:border-gold-500/30 hover:shadow-lg transition-all group">
                ...
                <h3 className="font-serif text-xl font-bold text-primary-50 mb-4">Email Us</h3>
