      ...
      <div className="container mx-auto px-4 md:px-8 flex items-center justify-between">
        ...
        <a href="#" className="flex items-center gap-4 group">
          <div className="w-12 h-12 relative">
             ...
             <div className="relative w-full h-full border border-gold-500/30 rounded-full flex items-center justify-center text-gold-400 group-hover:scale-105 transition-transform duration-500 bg-primary-900/50 backdrop-blur-sm p-1.5">
               <img 
                 src="/logo.png" 
                 alt="YIKANG TCM Logo" 
