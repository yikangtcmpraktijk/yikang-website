    ...
    <div className="min-h-screen flex flex-col font-sans text-primary-100 selection:bg-gold-500 selection:text-white">
      ...
      <footer className="bg-primary-950 text-primary-400 py-12 border-t border-primary-800">
        <div className="container mx-auto px-4 grid md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-sm leading-relaxed max-w-xs text-primary-300">
              Restoring balance and health through the ancient wisdom of Traditional Chinese Medicine and modern compassionate care.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><a href="#services" className="hover:text-gold-400 transition-colors">Acupuncture</a></li>
              <li><a href="#services" className="hover:text-gold-400 transition-colors">Tui-Na Therapy</a></li>
        ...
        <div className="container mx-auto px-4 mt-12 pt-8 border-t border-primary-800 text-center text-xs text-primary-500">
          &copy; {new Date().getFullYear()} Yikang TCM Praktijk. All rights reserved.
        </div>
      </footer>
    </div>
  );
